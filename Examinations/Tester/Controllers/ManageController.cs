...
{
    [LogonAuthorize(Roles = "Test")]
    public class ManageController : BaseController
    {
        public ManageController()
        {
            reportManager = new TechReportManager();
        }
        ...
        private ITechReportManager reportManager;
        ...
        public ActionResult PostTechReport()
        {
            return View();
        }

        [HttpPost]
        public ActionResult PostTechReport(TechReport tech)
        {
            ...
            var error = reportManager.Create(tech);
            if (!string.IsNullOrEmpty(error))
            {
                AddErrors(new IdentityResult(error));
                return View(tech);
            }
            return View("PostTechReportSuccess");
        }
        ...
        private void AddErrors(IdentityResult result)
        {
            ...
            {
                ModelState.AddModelError("ManageError", error);
            }
        }
